...
external_url 'http://gitlab.lam.local'
## Legend
...
#registry_external_url 'http://gitlab.lam.local:4567'
...
#pages_external_url 'http://lam.local'
...
mattermost_external_url 'http://mattermost.lam.local'
...
mattermost['log_console_level'] = 'DEBUG'
...
##! Advanced settings. Should be changed only if absolutely needed.
gitlab_monitor['listen_address'] = 'gitlab'
gitlab_monitor['port'] = '9168'
